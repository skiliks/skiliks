...
class PagesController extends SiteBaseController
{
    ...
    public function actionArticles()
    {
        ...
        $data[] = [
            ...
            'date' => 'декабрь 2013',
            'title' => 'Бизнес и практика. Skiliks можно использовать для оценки потребности в обучении и для оценки эффективности тренингов, проводя замеры до и после',
            'description' => 'Когда вы берете на работу менеджера, чего именно ожидаете от него? Когда вы приходите в компанию на позицию менеджера, как планируете строить свою работу? Команда Skiliks разработала онлайн симуляцию, позволяющую проверить базовые навыки менеджера. Zillion посмотрел, как это устроено, а сооснователи Skiliks рассказали, как происходит автоматизированная оценка управленческих навыков в формате Serious Game',
            'label' => 'zillion.net',
        ...
        $data[] = [
            ...
            'description' => 'Представитель стартапа для оценки менеджеров skiliks рассказал нам о том, как можно проверить сотрудника при приеме на работу, что такое "serious games" и о том, что без корпоративного почтового клиента не может работать ни одна компания',
