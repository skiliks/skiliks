...
//админка *****************************************************
            ...
            urls : {
                ...
                login: '/auth/auth',
                logout: '/auth/logout',
                register: '/registration/save',
                lostpass: '/password/remember',
                ...
                addTriggerAdd: '/events/start',
                addAssessmentGetList: '/simulation/getPoint',
                dayPlanTodoGet: '/todo/get',
                dayPlanDayPlanGet: '/dayPlan/get',
                dayPlanTodoAdd: '/todo/add',
                dayPlanDayPlanAdd: '/dayPlan/add',
                excelGet: '/excelDocument/get',
                excelGetWorksheet: '/excelDocument/getWorksheet',
                excelSaveDocument: '/excelDocument/saveDocument',
                excelSaveEdit: '/excelDocument/save',
                excelApplyPaste: '/excelDocument/paste',
                excelApplySumm: '/excelDocument/sum',
                excelApplyAverage: '/excelDocument/avg',
                excelApplyDrawing: '/excelDocument/drawing',
                simulationStop: '/simulation/stop',
                mailGetFolders: '/mail/getFolders',
                mailGetMessages: '/mail/getMessages',
                mailGetMessage: '/mail/getMessage',
                mailGetSettings: '/mail/getSettings',
                mailSaveSettings: '/mail/saveSettings',
                mailGetReceivers: '/mail/getReceivers',
                mailGetThemes: '/mail/getThemes',
                mailGetPhrases: '/mail/getPhrases',
                mailMessageDelete: '/mail/delete',
                mailGetMessageFull: '/mail/getMessage',
                mailMarkRead: '/mail/markRead',
                mailSendMessage: '/mail/sendMessage',
                mailMessageTransfer: '/mail/move',
                mailSaveDraft: '/mail/saveDraft',
                mailMessageReply: '/mail/reply',
                mailMessageReplyAll: '/mail/replyAll',
                mailMessageToPlan: '/mail/toPlan',
                mailMessageForward: '/mail/forward',
                mailSendDraftLetter: '/mail/sendDraft',
                mailAddTask: '/mail/addToPlan',
                documentsGetList: '/myDocuments/getList',
                mailGetDocumentsList: '/myDocuments/getList',
                mailSaveDocument: '/myDocuments/add',
                viewerGet: '/viewer/get',
                phoneGetContacts: '/phone/getContacts',
                phoneGetHistory: '/phone/getList',
                phoneCallTo: '/phone/call',
                timerSetNewTime: '/simulation/changeTime',
                ...
                //админка *****************************************************
                dialogsSelectsRequest: '/dialogs/getSelect',
                dialogsGetPointsRequest: '/dialogs/getPoints',
                saveCharactersPoints: '/dialogs/savePoints',
                eventsSamplesSelectsRequest: '/eventsSamples/getSelect',
                eventsChoicesSelectsRequest: '/eventsChoices/getSelect',
                charactersPointsTitlesSelectsRequest: '/charactersPointsTitles/getSelect'
