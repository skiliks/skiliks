simulation = {
    ...
    start:function (stype) {
        //логируем событие
        var simulation = SKApp.user.startSimulation(stype);
...
//        SKApp.server.api('simulation/start', {'stype': stype}, function (data) {
...
//        });
    ...
    applyStop:function () {
        ...
        var simulation = new SKSimulationStartView({'el': $('body')});
