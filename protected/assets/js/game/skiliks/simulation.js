simulation= {
    ...
    drawLocation: function(name)
    {
        ...
        object.sx = 0;
        object.sy = 0;
        object.centerX = config.activeFrame.width/2;
        object.cenerY = config.activeFrame.height/2;
        object.dWidth = config.activeFrame.width;
        object.dHeight = config.activeFrame.height;
        object.angle = 0;
        object.scaleX = 1;
        object.alpha = 1;
