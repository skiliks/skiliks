            ...
            onZohoPopup: function(){
                ...
                if($('.time').hasClass('paused')){
                    ...
                    me.zoho_popup = new SKDialogView({
                        'message': "Пожалуйста, убедитесь в том, что вы сохранили правки в сводном бюджете. <br/>" +
                            "Для этого откройте Мои документы, <br/> потом 'Сводный бюджет_2013_утв.xls' <br/> и нажмите кнопку Save. <br/>" +
