    ...
    spec = describe('new mail', function (run) {
        ...
        run(function () {
            ...
            before(function () {
                ...
                server.respondWith("POST", "/index.php/mail/move",
                    [200, { "Content-Type":"application/json" },
                        JSON.stringify({result:1})]);
...
;
                ...
                //console.log(mailClientView.mailClient.activeEmail);
                server.respond();
                //console.log(server.requests);
                server.requests.forEach(function(request){
                    if(request.url === '/index.php/mail/move'){
                        expect(request.requestBody).toBe('folderId=4&messageId=1274');
                    }
                });
