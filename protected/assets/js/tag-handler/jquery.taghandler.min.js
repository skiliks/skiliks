    ...
    $.fn.tagHandler = function (options) {
        ...
        if (typeof(options) == 'object' || typeof(options) == 'undefined') {
            ...
            return this.each(function () {
                ...
                if (opts.allowEdit) {
                    ...
                    if (opts.autocomplete && typeof($.fn.autocomplete) == 'function' && opts.initLoad) {
                        ...
                        $(inputField).autocomplete({
                            open: function () {
                                $(this).data("autocomplete").menu.element.addClass("mailclient-autocomplite");
                            },
                    ...
                    //Нужно чтоб в IE10-11 не было лишьнего списка после добавления бабла SKILIKS-4895
                    ...
                    tagContainerObject.click(function () {
                        ...
                        if ($(inputField).val() === '' && opts.autocomplete && typeof($.fn.autocomplete) == 'function' && opts.initLoad) {
                            if($(inputField).autocomplete('widget').is(':visible')){
                                ...
                                $(inputField).autocomplete("search", "");
                                setTimeout(function() {
                                     $(document).bind('click.closeTagHandler', function(event) {
                                     $(inputField).autocomplete('close');
                                     $(document).unbind('click.closeTagHandler');
                                     });
                                }, 0);
                            }
                        }
                ...
                this.addTag = function (tag_el, tag) {
                    tags = addTag(tag_el, tag, tags, opts.sortTags);
                    if (opts.updateURL !== '' && opts.autoUpdate) {
                        saveTags(tags, opts, tagContainer.id);
                    }
                    if (typeof(opts.afterAdd) == "function") {
                        opts.afterAdd.call(this, tag);
                    }
                };
                this.removeTag = function (tag_el) {
                    tags = removeTag(tag_el, tags, opts.sortTags);
                    if (opts.updateURL !== '' && opts.autoUpdate) {
                        saveTags(tags, opts, tagContainer.id);
                    }

                    if (typeof(opts.afterDelete) === "function") {
                        opts.afterDelete.call(this, $.trim($(tag_el).text()));
                    }
