...
//
   ...
   s_parseerrexponent: "Неправильне экспоненты числа",
   s_parseerrchar: "Неожиданный символ в формуле",
   s_parseerrstring: "Деформированность строки",
   s_parseerrspecialvalue: "Деформированность особоого значения",
   s_parseerrtwoops: "Ошибка в формуле (два оператора неуместно в ряду)",
   s_parseerrmissingopenparen: "Отсутствует открывающая скобка в списке через запятую ",
   s_parseerrcloseparennoopen: "Закрывающая скобка без открывающей скобки. ",
   s_parseerrmissingcloseparen: "Отсутствует закрывающая скобка. ",
   s_parseerrmissingoperand: "Отсутствует операнд. ",
   s_parseerrerrorinformula: "Ошибка в формуле",
   s_calcerrerrorvalueinformula: "Ошибочное значение в формуле",
   s_parseerrerrorinformulabadval: "Ошибка в формуле приводит к плохим соотношением",
   s_formularangeresult: "Результаты формулы в диапазон значений:",
   s_calcerrnumericnan: "Формула приводит к плохиму числовому значению",
   s_calcerrnumericoverflow: "Переполнение",
   s_sheetunavailable: "Лист недоступны:", // when FindSheetInCache returns null
   s_calcerrcellrefmissing: "Ссылка на ячейку отсутствует, когда ожидалось",
   s_calcerrsheetnamemissing: "Имя листа отсутствует, когда ожидалось.",
   s_circularnameref: "Циклическая ссылка имени на имя",
   s_calcerrunknownname: "Неизвестное имя",
   s_calcerrincorrectargstofunction: "Неправильные аргументы функции",
   s_sheetfuncunknownfunction: "Неизвестная функция",
   s_sheetfunclnarg: "LN аргумент должен быть больше 0",
   s_sheetfunclog10arg: "LOG10 аргумент должен быть больше 0",
   s_sheetfunclogsecondarg: "LOG второй аргумент должен быть числовым больше 0",
   s_sheetfunclogfirstarg: "LOG Первый аргумент должен быть больше 0",
   s_sheetfuncroundsecondarg: "ROUND Второй аргумент должен быть числовым",
   s_sheetfuncddblife: "DDB жизни должно быть больше 1",
   s_sheetfuncslnlife: "SLN жизни должно быть больше 1",
