...
return array(
    ...
    'Iron lady<br />Effectiveness champion<br />Mentor to everyone<br />Structure wizard<br /><span class=dots></span>simply The Boss &amp; Visionary' => 'Железная леди<br />Чемпион по эффективности<br />Наставник для каждого, кто есть рядом<br />Маг структурирования<br /><span class=dots></span> просто Босс и Визионер',
    ...
    'Last Name' => 'Фамилия',
    'Last name' => 'Фамилия',
    'First name is required' => 'Введите имя',
    'Email is required' => 'Введите email',
    'Login (email) is required' => 'Введите логин (email)',
    'Professional status is required' => 'Введите статус',
    'Industry is required' => 'Введите область деятельности',
    'Wrong email' => 'Email введён неверно',
    ...
    'Scope of measured qualities' => 'Измеряемые характеристики',
    'Sticks to goals and priorities' => 'Следование приоритетам',
    'Manages tasks effectively' => 'Управление задачами',
    'Uses planning during the day' => 'Использование планирования в течение дня',
    'Correctly defines tasks’ priorities while planning' => 'Правильное определение приоритетов задач при планировании',
    'Uses planning during the day' => 'Использование планирования в течение дня',
    ...
    'Resistance to manipulation' => 'Устойчивость к манипуляциям и давлению',
    'Constructiveness' => 'Конструктивность',
    'Flexibility' => 'Гибкость',
    'Decision-making' => 'Принятие решений',
    'Speed of work' => 'Скорость работы',
    'Stress-resistance' => 'Стрессоустойчивость',
    'Sticks to company goals' => 'Следование целям подразделения',
    'Follows personal priorities' => 'Следование личным приоритетам',
    'Uses planning during the day' => 'Использование планирования в течение дня',
    'Correctly defines tasks’ priorities while planning' => 'Правильное определение приоритетов задач при планировании',
    'Follows tasks priorities in execution' => 'Выполнение задач в соответствии с приоритетами',
    'Completes tasks in full' => 'Завершение начатых задач',
    'Wisely uses emails' => 'Оптимальное использование почты',
    'Wisely uses phone calls' => 'Оптимальное использование звонков',
    'Wisely uses meetings' => 'Оптимальное использование встреч',
    'Uses delegation to manage scope of work' => 'Использование делегирования для управления объемом задач',
    'Effectively manages resources with different qualification' => 'Управление ресурсами различной квалификации',
    'Uses feedback' => 'Использование обратной связи',
    'Delegates tasks to optimal employees' => 'Делегирование задачи оптимальному сотруднику',
    'Manages time spent on emails' => 'Управление временем, затрачиваемым на почту',
    'Effectively processes incoming emails' => 'Эффективная обработка входящих писем',

    'Creates informative and short messages' => 'Создание информативных и экономных сообщений',
    'Manages time spent on phone calls' => 'Управление временем, затрачиваемым на звонки',
    'Reasonably answers incoming calls' => 'Целесообразный прием входящих звонков',
    'Effectively processes incoming calls' => 'Эффективная обработка входящих звонков',
