...
return array(
    ...
    'Our simulation is easy and reliable way to discover your people management skills:' => 'Наша симуляция – простой и надежный способ проверить базовые навыки менеджеров',
    'Easy' => 'Простой',
    'Saves your time' => 'Экономит время',
    ...
    '50% discount for all tariffs till April 15' => 'Скидка 50% на весь 2014 год при оплате до 15 апреля',
    ...
    'Speed of getting results'                   => 'Время, затраченное на выполнение задач',
    ...
    'Completes tasks in full' => 'Прерывание при выполнении задач',
