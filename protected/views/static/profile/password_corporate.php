...
<?php $this->renderPartial('_menu_corporate', ['active' => ['password' => true]]) ?>
    ...
    <div class="form profileform radiusthree">
        ...
        <div class="row">
            <p class="text16"><?php echo Yii::t('site', 'Установите новый пароль или <a href="/recovery?YumPasswordRecoveryForm[email]='.$profile->email.'" class="lbluelink">восстановите</a> текущий'); ?></p>
        </div>
