<div class="extrasidepads">
    ...
    <div class="clearfix mangrlresults">
        <div class="labels labels1">
            <p class="labelwrap"><span class="thelabel"><span class="list-counter">1.1 </span><a href="#" class="list-link">Определение приоритетов</a></span></p>
            <p class="labelwrap"><span class="thelabel"><span class="list-counter">1.2 </span><a href="#" class="list-link">Использование планирования в течение дня</a></span></p>
            <p class="labelwrap"><span class="thelabel"><span class="list-counter">1.3 </span><a href="#" class="list-link">Правильное определение приоритетов задач при планировании</a></span></p>
            <p class="labelwrap"><span class="thelabel"><span class="list-counter">1.4 </span><a href="#" class="list-link">Выполнение задач в соответствии с приоритетами</a></span></p>
            <p class="labelwrap"><span class="thelabel"><span class="list-counter">1.5 </span><a href="#" class="list-link">Завершение начатых задач</a></span></p>
        </div>
        <div class="barswrap">
