    ...
    <div class="timeblock">
        ...
        <div class="legendwrap">
            <div class="legend">
                ...
                <div class="legendvalue"><span class="legendcolor colordone"></span><span class="legendtitle">Действия, относящиеся к задачам 1 приоритета</span></div>
                ...
                <div class="legendvalue"><span class="legendcolor colormax"></span><span class="legendtitle">Время ожидания</span></div>
            </div>
        </div>
    </div>
