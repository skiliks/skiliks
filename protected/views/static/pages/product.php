...
<article class="product">
    ...
    <div class="rateslist">
        ...
        <span class="widthblock column-1-3 vertical-align-top">
            ...
            <ul class="bluelist nobultslist hide">
    ...
    <section>
        ...
        <div class="column-full">
            <span class="column-1-2 pull-content-center">
                <h1><?= Yii::t('site', 'Easy')?></h1>
            </span>
            <span class="column-1-2 pull-content-center">
                <h1><?= Yii::t('site', 'Reliable')?></h1>
            </span>
        </div>
        <div class="column-full pull-content-center">
            <span class="column-1-2 vertical-align-top">
                    <br/>
