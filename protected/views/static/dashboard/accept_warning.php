<div id="invite-accept-form" style="display: none;">
    ...
    <div class="container-4">
        <div class="grid1"><h4>Интернет</h4><p>Обеспечьте хорошее Интернет соединение. Симуляция не запустится при скорости менее 1Мб в секунду.</p></div>
        <div class="grid1"><h4>Браузер</h4><p>Убедитесь, что у вас установлен браузер Firefox (от 18 версии) или Chrome (от 22 версии). При необходимости установите последние версии данных браузеров.</p></div>
        <div class="grid1"><h4>Лишние программы</h4><p>Перед прохождением симуляции мы рекомендуем закрыть все приложения, кроме браузера.</p></div>
        <div class="grid1"><h4>Демо</h4><p>Пройдите демо-версию симуляции. Это позволит вам легче ориентироваться в новом интерфейсе.</p></div>
    </div>
