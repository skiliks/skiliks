...
<div class="tariff-replace-now-popup" style="display: none;">
    <div class="more-side-pads">
        ...
        <ul class="list-ordered">
            <p class="font-xxlarge">У вас остались симуляции (<?php echo $account->getTotalAvailableInvitesLimit() ?> шт.). Если вы хотите перейти на новый тариф прямо сейчас, то эти симуляции сгорят</br>
            </p>
        </ul>
