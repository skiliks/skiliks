<div class="extrasidepads">
    ...
    <div class="clearfix-simulation-results mangrlresults">
        <div class="labels labels1">
            <div class="labelwrap"><div class="popover hide"><div class="popover-triangle"></div><div class="popover-content"><div class="popup-content ">Определение приоритетов между личными и рабочими задачами, учёт данных приоритетов при выполнении задач. Способность влиять на постановку новых задач, в том числе от руководства, основываясь на  сформированных приоритетах, а также пересматривать приоритеты в случае необходимости.</div></div></div><span class="thelabel"><div><span class="list-counter">1.1 </span><a href="#" class="list-text">Определение приоритетов</a></div></span><a class="questn show-popover show-popover-1 popover-margin1" href="#"></a></div>
            <div class="labelwrap"><div class="popover hide"><div class="popover-triangle"></div><div class="popover-content"><div class="popup-content ">Постановка всех текущих задач в план до начала их выполнения, формирование реализуемого плана на день. Определение конкретного времени выполнения для всех задач, в том числе долгосрочных</div></div></div><span class="thelabel"><div><span class="list-counter">1.2 </span><a href="#" class="list-text">Использование планирования в течение дня</a></div></span><a class="questn show-popover show-popover-1 popover-margin1" href="#"></a></div>
            <div class="labelwrap"><div class="popover hide"><div class="popover-triangle"></div><div class="popover-content"><div class="popup-content ">По всем текущим задачам постановка в план самой приоритетной задачи на самое раннее время, по сравнению с менее приоритетной, при условии, что у задачи нет фиксированного времени выполнения</div></div></div><span class="thelabel"><div><span class="list-counter">1.3 </span><a href="#" class="list-text">Правильное определение приоритетов задач при планировании</a></div></span><a class="questn show-popover show-popover-1 popover-margin3" href="#"></a></div>
            <div class="labelwrap"><div class="popover hide"><div class="popover-triangle"></div><div class="popover-content"><div class="popup-content ">Всегда выполняется самая приоритетная задача из всех известных на данный момент</div></div></div><span class="thelabel"><div><span class="list-counter">1.4 </span><a href="#" class="list-text">Выполнение задач с учётом приоритетов</a></div></span><a class="questn show-popover show-popover-1 popover-margin3" href="#"></a></div>
