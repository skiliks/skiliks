<div class="team">
	...
	<div class="team-values">
        <h2 class="font-blue-dark text-center"><?php echo Yii::t('site', 'Our Values') ?></h2><ul class="font-xlarge">
