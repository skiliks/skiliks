<ul class="side-menu">
    ...
    <li class="side-item <?php if (isset($active['vacancies'])){ echo 'active proxima-bold'; } else {echo 'proxima-reg'; }?>"><a href="/profile/corporate/vacancies">Вакансии</a></li>
    <li class="side-item <?php if (isset($active['tariff'])){ echo 'active semi'; } else {echo 'proxima-reg'; } ?>"><a href="/profile/corporate/tariff" class="<?php if (isset($active['tariff'])){ echo 'proxima-bold'; } ?>">Тариф</a></li>
