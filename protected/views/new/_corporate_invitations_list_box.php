...
$this->widget('zii.widgets.grid.CGridView', [
    ...
    'columns' => [
        ...
        ['header' => ''                                                     , 'value' => '"<a class=\"inviteaction font-small\" href=\"/dashboard/invite/remove/$data->id\">Удалить</a>"'                , 'type' => 'html'],
        ['header' => ''                                                     , 'value' => '"<a class=\"inviteaction font-small\" href=\"/dashboard/invite/resend/$data->id\">Отправить ещё раз</a>"' , 'type' => 'html'],
    ]
]);
?>
