    ...
    <div class="order-header">
        ...
        <div class="order-status">
            <div class="row font-white">
                ...
                <div class="value grid-cell"><strong class="font-xslarge"><?= strtolower($account->getTariffLabel()) ?></strong><small class="tarifprice"><?= $account->tariff->getFormattedPrice() ?> в месяц</small>
                </div>
            </div>
            <div class="row font-white">
