...
<html lang="<?php echo Yii::t('site', 'en') ?>">
    ...
    <script type="text/javascript">
        Cufon.replace('.menu-site, .unstyled, .inner .site-main p, span, label, input, select, .proxima-reg, .sbHolder a, .errorMessage, .feedback-dialog-title, .to-top, small, .team-values', {fontFamily:"ProximaNova-Regular", hover: true});
