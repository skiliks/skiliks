...
<html lang="<?php echo Yii::t('site', 'en') ?>">
    ...
    <script type="text/javascript">
        Cufon.replace('li, p, label, input, select, .proxima-reg, .sbHolder a, .errorMessage, .feedback-dialog-title, .to-top', {fontFamily:"ProximaNova-Regular", hover: true});
        ...
        Cufon.replace('.semi, .yiiPager li, .yiiPager a, .yiiPager .next a, .yiiPager .previous a', {fontFamily:"ProximaNova-Regular", hover: true});
