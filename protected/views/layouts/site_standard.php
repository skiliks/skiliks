...
<html lang="<?php echo Yii::t('site', 'en') ?>">
    ...
    <script type="text/javascript">
        Cufon.replace('.menu-site, .unstyled, .site-main p, span, label, input, select, .proxima-reg, .sbHolder a, .errorMessage, .feedback-dialog-title, .to-top, small', {fontFamily:"ProximaNova-Regular", hover: true});
