...
<html lang="<?php echo Yii::t('site', 'en') ?>">
    ...
    <script type="text/javascript">
        Cufon.replace('.menu-site li, .unstyled li, p, label, input, select, .proxima-reg, .sbHolder a, .errorMessage, .feedback-dialog-title, .to-top, small, .side-menu', {fontFamily:"ProximaNova-Regular", hover: true});
        Cufon.replace('.btn, .proxima-bold, h1, h2, h3, h4, h5, strong, .dark-labels label, .list-dark li, .items th, .items td, .add-vacancy-popup h1, .ui-dialog-title, ' +
            '.side-menu li.active a', {fontFamily:"ProximaNova-Bold", hover: true});
