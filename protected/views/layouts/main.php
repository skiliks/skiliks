		...
		<div class="<?php echo StaticSiteTools::getContainerClass(Yii::app()->request) ?>" id="top">
            ...
            <div class="footer">
                <footer>
                    ...
                    <p class="copyright" style="font-size:11px;">Copyright - Skiliks  - 2012 <span class="float-right">Свяжитесь с нами: <a href="mailto:help@skiliks.com">help@skiliks.com</a></span></p>
