    ...
    <body class="<?php echo StaticSiteTools::getBodyClass(Yii::app()->request) ?>">
		...
		<div class="<?php echo StaticSiteTools::getContainerClass(Yii::app()->request) ?>" id="top">
			...
			<div class="content">
			    ...
			    <?php echo $content; ?>
                <iframe id="JotFormIFrame" onload="window.parent.scrollTo(0,0)" allowtransparency="true" src="http://form.jotformeu.com/form/30835043655352" frameborder="0" style="width:100%; height:513px; border:none;" scrolling="no"></iframe>
