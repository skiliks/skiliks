...
<div class="grid-container">
    ...
    <div class="container-3">
        <div class="grid1 text-center font-white">
            Вам потребуется не более пяти минут, чтобы отправить приглашение и получить результаты. По каждому кандидату вам будет предоставлен исчерпывающий отчет о результативности,  проявленных навыках и качествах менеджера.
        </div>
        <div class="grid1 text-center font-white">
            Кандидату потребуется 2-3 часа, чтобы пройти увлекательную игру с глубоким погружением в реальную рабочую среду с менеджерскими задачами и ситуациями принятия управленческих решений.
        </div>
        <div class="grid1 text-center font-white">
            Вы сможете сравнить между собой кандидатов с самым разнообразным опытом, из разных отраслей или регионов, по одинаковой шкале оценки навыков, качеств и достигнутых результатов.
        </div>
    </div>
</div>
</body>
