    ...
    <footer class="site-footer">
        <div class="grid-container">
            ...
            <div class="container-3 container proxima-reg">
                <div class="grid1 empty-block" style="border:1px solid red;">&nbsp;</div><div class="grid1 text-center">Copyright - Skiliks  - 2012</div><div class="grid1 text-right">Свяжитесь с нами: <a href="mailto:help@skiliks.com">help@skiliks.com</a></div>
            </div>
