...
Приветствуем, <?= $invite->getReceiverFirstName() ?>!</h1>
...
<ul>
    ...
    <li><a style="text-decoration:none;color:#147b99;font-family:Tahoma, Geneva, sans-serif;font-size:14px;"  href="<?= $link.'&redirect=simulations' ?>">пройти симуляцию самостоятельно.</a></li>
</ul>
