...
Благодарим вас за выбор skiliks!</h1>
                                    <p style="margin:0 0 15px 0;color:#555545;font-family:Tahoma, Geneva, sans-serif;font-size:14px;text-align:justify;line-height:20px;">Пожалуйста, <a href="<?= $link ?>">активируйте</a> ваш аккаунт.</p>
