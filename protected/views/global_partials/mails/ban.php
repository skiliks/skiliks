                            ...
                            <tr>
                                <td valign="top" bgcolor="fdfbc6">
                                    ...
                                    <p style="margin:0 0 15px 0;color:#555545;font-family:Tahoma, Geneva, sans-serif;font-size:14px;text-align:justify;line-height:20px;">
                                        ...
                                        корпоративный профиль с некорпоративым адресом электронной почты <?=$email ?>.
                                    </p>
            ...
            <table cellpadding="0" cellspacing="0" width="840">
                <tr>
                    ...
                    <td bgcolor="fdfbc6" width="760">
                        <p style="margin:0 0 15px 0;text-align:justify;line-height:20px;"><strong style="color:#555545;font-family:Tahoma, Geneva, sans-serif;font-weight:bold;font-size:14px">Служба технической поддержки www.skiliks.com</strong></p>
                    </td>
                    <td bgcolor="fdfbc6">
                        <table cellspacing="0" cellpadding="15"><tbody><tr><td></td></tr></tbody></table>
                    </td>
