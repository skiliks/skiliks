...
<p>
    <?php if ($isSimComplete): ?>
        ...
        <span <?php echo 'data-simulation="/simulations/details/'.$simulation->id.'"'; ?>
            ...
            <span class="ratebg block-stars"><span class="rating block-stars" style="width: <?php echo $simulation->getCategoryAssessment(); ?>%"></span></span><span class="prcentval block-stars"><!--<sup>-->
