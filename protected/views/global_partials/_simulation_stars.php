...
<p>
    ...
    <span <?php if (null !== $simulation) { echo 'data-simulation="/simulations/details/'.$simulation->id.'"';} ?>
        ...
        <span class="ratebg"><span class="rating" style="width: <?php if(null!==$simulation AND $simulation->end !== null AND $simulation->isFull()) { echo $simulation->getCategoryAssessment(); }else{ echo "0"; } ?>%"></span></span><span class="prcentval"><!--<sup>-->
