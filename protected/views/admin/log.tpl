...
<dl>
    ...
    <dt>Оценка по положительной шкале (поведения 1Х - 5Х)</dt>
    <dd>X</dd>
    <dt>Оценка по отрицательной шкале (поведения 1Х - 5Х)</dt>
    <dd>X</dd>
    <dt>Оценка личностных характеристик (поведения 6Х - 8Х)</dt>
    <dd>X</dd>
</dl>
