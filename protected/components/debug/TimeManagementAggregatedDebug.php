 ...
 */
class TimeManagementAggregatedDebug extends CActiveRecord
{
	 ...
	 * @return TimeManagementAggregatedDebug the static model class
	 */
	...
	{
		return 'time_management_aggregated_debug';
	}
