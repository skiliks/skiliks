...
return array(
    ...
    'params' => array(
        ...
        'emails' => [
            ...
            'defaultMessageText' => 'Поздравляем вас! Вы зачислены в лонг-лист кадрового резерва Системы Дистрибуции Эксмо!<br/>
                                     Следующий шаг - составить индивидуальные планы развития для каждого из вас.<br/>
