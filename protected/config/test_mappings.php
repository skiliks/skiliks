...
return [
    ...
    'mail_contacts' => [
        ...
        'ludovkina' => "//ul[contains(@class,'ui-autocomplete')]/li[13]/a",
        'miagkov' => "//ul[contains(@class,'ui-autocomplete')]/li[14]/a",
        'petrashevich' => "//ul[contains(@class,'ui-autocomplete')]/li[15]/a",
        'razumnui' => "//ul[contains(@class,'ui-autocomplete')]/li[16]/a",
        'skorobey' => "//ul[contains(@class,'ui-autocomplete')]/li[17]/a",
        'tochnuh' => "//ul[contains(@class,'ui-autocomplete')]/li[18]/a",
        'trudyakin' => "//ul[contains(@class,'ui-autocomplete')]/li[19]/a",
        'trutnev' => "//ul[contains(@class,'ui-autocomplete')]/li[20]/a",
        'hozin' => "//ul[contains(@class,'ui-autocomplete')]/li[21]/a",
    ],
