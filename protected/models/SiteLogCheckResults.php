...
/**
 * This is the model class for table "site_log_check_results".
 *
 * The followings are the available columns in table 'site_log_check_results':
 * @property integer $id
...
class SiteLogCheckResults extends CActiveRecord
{
	 ...
	 * @return SiteLogCheckResults the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, started_at, finished_at, started_by_id, result', 'safe', 'on'=>'search'),
		);
	}
