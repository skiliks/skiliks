...
class m131202_100436_free_email_provider extends CDbMigration
{
	public function up()
	{
        $this->addColumn('free_email_provider', 'security_risk' ,"varchar(30) default 'free_mail'");

        $ten_minutes_emails = '0-mail.com,0815.ru,0clickemail.com,
        ...
        fakeinbox.com,fakeinformation.com,fastacura.com,
        filzmail.com,fizmail.com,fr33mail.info,
        get1mail.com,get2mail.fr,getonemail.com,
        getonemail.net,gishpuppy.com,great-host.in,
        guerillamail.com,guerrillamail.com,guerrillamailblock.com,
        h.mintemail.com,haltospam.com,hochsitze.com,
        hotpop.com,hulapla.de,ieatspam.eu,
        ieatspam.info,imails.info,incognitomail.com,
        incognitomail.net,incognitomail.org,insorg-mail.info,
        ipoo.org,jetable.com,jetable.net,
        jetable.org,jnxjn.com,junk1e.com,
        keepmymail.com,kir.ch.tc,klzlk.com,
        kulturbetrieb.info,lhsdv.com,litedrop.com,
        lol.ovpn.to,lookugly.com,lopl.co.cc,
        m4ilweb.info,mail-temporaire.fr,mail.by,
        mail4trash.com,mailcatch.com,maileater.com,
        mailexpire.com,mailin8r.com,mailinator.com,
        mailinator.net,mailinator2.com,mailme.ir,
        mailme.lv,mailmetrash.com,mailnator.com,
        mailnesia.com,mailnull.com,mailslite.com,
        ...
        onewaymail.com,online.ms,ovpn.to,
        owlpic.com,pjjkp.com,politikerclub.de,
        pookmail.com,prtnx.com,qq.com,
        quickinbox.com,recode.me,regbypass.com,
        ...
        shitmail.me,skeefmail.com,slopsbox.com,
        smellfear.com,snakemail.com,sofimail.com,
        sofort-mail.de,sogetthis.com,spam.la,
        ...
        trashmail.net,trashmail.ws,trashmailer.com,
        trashymail.com,trashymail.net,trillianpro.com,
        tyldd.com,uggsrock.com,veryrealemail.com,
        webm4il.info,wegwerfemail.de,wh4f.org,
        whyspam.me,willselfdestruct.com,wuzupmail.net,
        yopmail.com,yuurok.com,zehnminutenmail.de,
        zippymail.info,zoaxe.com';

        $ten_minutes_emails = explode(',', $ten_minutes_emails);

        foreach($ten_minutes_emails as $domain) {
            if(empty($domain)){
                continue;
            }
            $email = FreeEmailProvider::model()->findByAttributes(['domain'=>trim($domain)]);
            if(null !== $email) {
                $email->security_risk = FreeEmailProvider::TEN_MINUTES_MAIL;
                $email->save(false);
            } else {
	...
	{
        $this->dropColumn('free_email_provider', 'security_risk');
	}
