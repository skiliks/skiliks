...
class m140530_112013_add_project_configs extends CDbMigration
{
	public function up()
	{
        ...
        INSERT INTO `project_config` (`id`, `alias`, `type`, `value`, `is_use_in_simulation`, `description`) VALUES
            (2, 'chrome_version_to_block', 'String', '', NULL, 'Версии хрома, в которых запрещено начинать симуляцию.\r\nНастройка нужна, чтоб можно было экстренно заблокировать какую-то версию браузера, если в ней обнаружился критический баг.\r\nПустое после - во всех версиях хрома можно играть.'),
            (3, 'internet_explorer_version_to_block', 'String', '', NULL, 'Версии internet explorer, в которых запрещено начинать симуляцию.\r\nНастройка нужна, чтоб можно было экстренно заблокировать какую-то версию браузера, если в ней обнаружился критический баг.\r\nПустое после - во всех версиях хрома можно играть.'),
            (4, 'firefox_version_to_block', 'String', '', NULL, 'Версии Firefox, в которых запрещено начинать симуляцию.\r\nНастройка нужна, чтоб можно было экстренно заблокировать какую-то версию браузера, если в ней обнаружился критический баг.\r\nПустое после - во всех версиях хрома можно играть.'),
            (5, 'safari_version_to_block', 'String', '', NULL, 'Версии сафари, в которых запрещено начинать симуляцию.\nНастройка нужна, чтоб можно было экстренно заблокировать какую-то версию браузера, если в ней обнаружился критический баг.\nПустое после - во всех версиях хрома можно играть.');
        ");
	}
