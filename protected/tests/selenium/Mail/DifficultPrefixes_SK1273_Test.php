...
class DifficultPrefixes_SK1273_Test extends SeleniumTestHelper
{
    ...
    public function test_DifficultPrefixes_SK1273_Case1() {
        ...
        $this->assertFalse($this->isElementPresent(Yii::app()->params['test_mappings']['active_icons']['active_mail']));
    ...
    public function test_DifficultPrefixes_SK1273_Case2() {
        ...
        $this->start_simulation();
        sleep(30);
        $this->run_event('M65',Yii::app()->params['test_mappings']['active_icons']['active_mail'], 'click');
