...
class ZIndexOfWindows_SK3361_Test extends SeleniumTestHelper
{
    public function test_ZIndexOfWindows_SK3361 ()
    {
        ...
        // открыть план и считать положение окна
        ...
        // открыть почту и считать положение окна
        ...
        // проверить, что значения положения почты и планировщика правильные относительно друг друга
        $this->assertTrue($a_index<$b_index);
        // открыть телефон и считать положение окна
        ...
        // проверить, что значения положения почты и телефона правильные относительно друг друга
