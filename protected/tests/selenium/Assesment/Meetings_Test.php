...
class Meetings_Test extends SeleniumTestHelper
{
    public function test_meetings_management()
    {
        ...
        sleep(2);
        $this->run_event('ET3.2',Yii::app()->params['test_mappings']['active_icons']['active_door'],'click');
        ...
        sleep(2);
        $this->run_event('ET13',Yii::app()->params['test_mappings']['active_icons']['active_door'],'click');
        $this->optimal_click(Yii::app()->params['test_mappings']['visit']['allow']);
        ...
        $this->run_event('ET15',Yii::app()->params['test_mappings']['active_icons']['active_door'],'click');
        sleep(10);
        ...
        $this->run_event('RVT1',Yii::app()->params['test_mappings']['active_icons']['active_door'],'click');
        $this->optimal_click(Yii::app()->params['test_mappings']['visit']['deny']);
        $this->run_event('RVT1.1',Yii::app()->params['test_mappings']['active_icons']['active_door'],'click');
        $this->optimal_click(Yii::app()->params['test_mappings']['visit']['deny']);
        $this->run_event('RVT1.2',Yii::app()->params['test_mappings']['active_icons']['active_door'],'click');
        $this->optimal_click(Yii::app()->params['test_mappings']['visit']['deny']);
