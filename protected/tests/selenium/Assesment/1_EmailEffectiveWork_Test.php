...
class EmailEffectiveWork_SK2557_Test extends SeleniumTestHelper
{
    public function test_EmailEffectiveWork_SK2557()
    {
        ...
        $event="RVT1";
        $this->run_event($event, Yii::app()->params['test_mappings']['active_icons']['active_door'], 'click');
        ...
        $this->run_event('ET8',Yii::app()->params['test_mappings']['active_icons']['active_door'],'click');
        $this->optimal_click(Yii::app()->params['test_mappings']['visit']['deny']);
        sleep(5);
        ...
        $this->run_event('ET9', Yii::app()->params['test_mappings']['active_icons']['active_door'], 'click');
        $this->optimal_click(Yii::app()->params['test_mappings']['phone']['reply']);
