...
class Calls_Management_Test extends SeleniumTestHelper
{
    public function test_Dialogs_for_SK2420_3()
    {
        ...
        sleep(2);
        $this->run_event('ET11', Yii::app()->params['test_mappings']['icons']['phone'], 'click');
        $this->optimal_click(Yii::app()->params['test_mappings']['phone']['reply']);
        ...
        sleep(2);
        $this->run_event('TT7.1.1', Yii::app()->params['test_mappings']['icons']['phone'], 'click');
        $this->optimal_click(Yii::app()->params['test_mappings']['phone']['reply']);
        ...
        sleep(2);
        $this->run_event('RST8', Yii::app()->params['test_mappings']['icons']['phone'], 'click');
        $this->optimal_click(Yii::app()->params['test_mappings']['phone']['reply']);
