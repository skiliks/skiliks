...
class Calls_Management_Test extends SeleniumTestHelper
{
    ...
    {
        $this->start_simulation("Calls_Management_Test", 1);
        ...
        sleep(2);
        $this->run_event('ET11', Yii::app()->params['test_mappings']['icons_active']['phone'], 'click');
        $this->optimal_click(Yii::app()->params['test_mappings']['phone']['reply']);
        ...
        sleep(2);
        $this->run_event('TT7.1.1', Yii::app()->params['test_mappings']['icons_active']['phone'], 'click');
        $this->optimal_click(Yii::app()->params['test_mappings']['phone']['reply']);
        ...
        sleep(2);
        $this->run_event('RST8', Yii::app()->params['test_mappings']['icons_active']['phone'], 'click');
        $this->optimal_click(Yii::app()->params['test_mappings']['phone']['reply']);
