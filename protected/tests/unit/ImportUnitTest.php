...
class ImportUnitTest extends CDbTestCase
{
    ...
    public function testFullImport()
    {
        ...
        try {
            ...
            $this->assertEquals(12, FlagBlockDialog::model()->count('scenario_id = '.$fullScenario->id), 'block dialog');
            $this->assertEquals(22, Flag::model()->count('scenario_id = '.$fullScenario->id), 'flags');
