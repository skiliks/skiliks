...
//админка *****************************************************
            ...
            urls : {
                //login
                auth: 1,
                login: '/index.php/auth/auth',
                logout: '/index.php/auth/logout',
                register: '/index.php/registration/save',
                lostpass: '/index.php/password/remember',
                checkSession: '/index.php/auth/checkSession',
                userAccountChangeEmail: '/index.php/userAccount/changeEmail',
                userAccountChangePassword: '/index.php/userAccount/changePassword',
                simulationStart: '/index.php/simulation/start',
                simulationGetNewEvents: '/index.php/events/getState',
                dialogsGetSelect: '/index.php/dialog/get',
                addTriggerGetList: '/index.php/events/getList',
                addTriggerAdd: '/index.php/events/start',
                addAssessmentGetList: '/index.php/simulation/getPoint',
                dayPlanTodoGet: '/index.php/todo/get',
                dayPlanDayPlanGet: '/index.php/dayPlan/get',
                dayPlanTodoAdd: '/index.php/todo/add',
                dayPlanDayPlanAdd: '/index.php/dayPlan/add',
                excelGet: '/index.php/excelDocument/get',
                excelGetWorksheet: '/index.php/excelDocument/getWorksheet',
                excelSaveDocument: '/index.php/excelDocument/saveDocument',
                excelSaveEdit: '/index.php/excelDocument/save',
                excelApplyPaste: '/index.php/excelDocument/paste',
                excelApplySumm: '/index.php/excelDocument/sum',
                excelApplyAverage: '/index.php/excelDocument/avg',
                excelApplyDrawing: '/index.php/excelDocument/drawing',
                simulationStop: '/index.php/simulation/stop',
                mailGetFolders: '/index.php/mail/getFolders',
                mailGetMessages: '/index.php/mail/getMessages',
                mailGetMessage: '/index.php/mail/getMessage',
                mailGetSettings: '/index.php/mail/getSettings',
                mailSaveSettings: '/index.php/mail/saveSettings',
                mailGetReceivers: '/index.php/mail/getReceivers',
                mailGetThemes: '/index.php/mail/getThemes',
                mailGetPhrases: '/index.php/mail/getPhrases',
                mailMessageDelete: '/index.php/mail/delete',
                mailGetMessageFull: '/index.php/mail/getMessage',
                mailMarkRead: '/index.php/mail/markRead',
                mailSendMessage: '/index.php/mail/sendMessage',
                mailMessageTransfer: '/index.php/mail/move',
                mailSaveDraft: '/index.php/mail/saveDraft',
                mailMessageReply: '/index.php/mail/reply',
                mailMessageReplyAll: '/index.php/mail/replyAll',
                mailMessageToPlan: '/index.php/mail/toPlan',
                mailMessageForward: '/index.php/mail/forward',
                mailSendDraftLetter: '/index.php/mail/sendDraft',
                mailAddTask: '/index.php/mail/addToPlan',
                documentsGetList: '/index.php/myDocuments/getList',
                mailGetDocumentsList: '/index.php/myDocuments/getList',
                mailSaveDocument: '/index.php/myDocuments/add',
                viewerGet: '/index.php/viewer/get',
                phoneGetContacts: '/index.php/phone/getContacts',
                phoneGetHistory: '/index.php/phone/getList',
                phoneCallTo: '/index.php/phone/call',
                timerSetNewTime: '/index.php/simulation/changeTime',
                phoneGetSelect: '/index.php/dialog/get',
                phoneGetThemes: '/index.php/phone/getThemes',
                phoneCallIgnore: '/index.php/phone/ignore',
                mailGetInboxUnreadedCount: '/index.php/mail/getInboxUnreadedCount',
                dayPlanTodoGetCount: '/index.php/todo/getCount',
                excelPointsDraw: '/index.php/excelPoints/draw',
                excelPointsReload: '/index.php/debug/calcExcel',
                
                //админка *****************************************************
                dialogsSelectsRequest: '/index.php/dialogs/getSelect',
                dialogsGetPointsRequest: '/index.php/dialogs/getPoints',
                saveCharactersPoints: '/index.php/dialogs/savePoints',
                eventsSamplesSelectsRequest: '/index.php/eventsSamples/getSelect',
                eventsChoicesSelectsRequest: '/index.php/eventsChoices/getSelect',
                charactersPointsTitlesSelectsRequest: '/index.php/charactersPointsTitles/getSelect'
