...
//темы для общения начало
        ...
        historyOneHTML:'<li>' +
            '<table>' +
            '<tbody><tr>' +
            '<td class="phone-contact-list-img"><img alt="" src="img/phone/icon-call-{type}.png"></td>' +
            '<td>' +
        ...
        contactHTML:'<table>' +
            '<tr>' +
            '<td class="phone-contact-list-img"><img src="img/phone/icon-ch{charackter_id}.png" alt="" /></td>' +
            '<td>' +
            '<p class="phone-contact-list-f0">{name}</p>' +
        ...
        contactHTMLActive:'<table class="active">' +
            '<tbody><tr>' +
            '<td class="phone-contact-list-img"><img alt="" src="img/phone/icon-ch{id}-1.png"></td>' +
            '<td>' +
            '<p class="phone-contact-list-f0">{name}</p>' +
            '<p class="phone-contact-list-f1">{title}</p>' +
