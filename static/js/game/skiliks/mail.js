...
//            '</div>' +
        ...
        closeHtml:'<img src="/img/interface/close.png" onclick="mailEmulator.draw();" style="cursor:pointer;">',
        ...
        html:'<section class="mail">' +
            ...
            '</div>' +
            '</section>',
        fileHTML1:'<div class="documents-file" id="documentsFile_{id}" onclick="mailEmulator.setActiveFile({id})"><img src="/img/documents/{type}.png"> {name}</div>',
        fileHTML:'<li id="documentsFile_{id}" onclick="mailEmulator.setActiveFile({id})"><img src="/img/documents/{type}.png" style="width:25px;heigth:25px;"> {name}</li>',
