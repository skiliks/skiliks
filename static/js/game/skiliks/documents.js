documents = {
    ...
    folderHTML: '<div class="documents-folder" id="documentsFolder_{id}"><img src="/img/documents/folder.png"> {name}</div>',
    ...
    fileHTML: '<li id="documentsFile_{id}" onclick="documents.setActiveFile({id});" class="documents-file">'+
                    '<a href="#"><span class="files-img"><img src="img/files/icon-{type}.jpg" alt="" /></span><span class="files-title">{name}</span></a>'+
            '</li>',
